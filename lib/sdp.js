...
exports.RemoteSdp = exports.getCodecName = exports.OfferMediaSection = exports.AnswerMediaSection = exports.MediaSection = void 0;
const sdp_transform_1 = __importDefault(require("sdp-transform"));
const logger_1 = require("./logger");
const utils_1 = require("./utils");
const APP_NAME = require('../package').name;
const logger = (0, logger_1.createLogger)(APP_NAME);
class MediaSection {
        ...
        switch (offerMediaObject.type) {
            ...
            case "video": {
                ...
                for (const codec of answerRtpParameters.codecs) {
                    ...
                    const codecParameters = (0, utils_1.clone)(codec.parameters || {});
                    if (codecOptions) {
...
class RemoteSdp {
    ...
    getSdp() {
        ...
        return sdp_transform_1.default.write(this._sdpObject);
    }
