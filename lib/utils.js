...
exports.addLegacySimulcast = exports.getRtpEncodings = exports.applyCodecParameters = exports.getCname = exports.extractDtlsParameters = exports.extractRtpCapabilities = exports.generateRandomNumber = exports.clone = void 0;
...
function extractRtpCapabilities({ sdpObject }) {
    ...
    for (const m of sdpObject.media) {
        ...
        for (const fmtp of m.fmtp || []) {
            const parameters = sdp_transform_1.default.parseParams(fmtp.config);
