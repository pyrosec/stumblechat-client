...
exports.Transport = exports.DataConsumer = exports.DataProducer = exports.Consumer = exports.Producer = void 0;
const awaitqueue_1 = __importDefault(require("awaitqueue"));
const events_1 = require("./events");
const utils = __importStar(require("./utils"));
const ortc = __importStar(require("./ortc"));
const logger_1 = require("./logger");
const logger = (0, logger_1.getLogger)();
class Producer extends events_1.EnhancedEventEmitter {
    ...
    async setMaxSpatialLayer(spatialLayer) {
        if (this._closed)
            ...
            throw new Error("not a video Producer");
...
class Consumer extends events_1.EnhancedEventEmitter {
...
class DataProducer extends events_1.EnhancedEventEmitter {
...
class DataConsumer extends events_1.EnhancedEventEmitter {
...
class Transport extends events_1.EnhancedEventEmitter {
    constructor({ direction, id, iceParameters, iceCandidates, dtlsParameters, sctpParameters, iceServers, iceTransportPolicy, additionalSettings, proprietaryConstraints, appData, handlerFactory, extendedRtpCapabilities, canProduceByKind, }) {
        ...
        this._awaitQueue = new awaitqueue_1.default.AwaitQueue();
    ...
    _handleProducer(producer) {
        ...
        producer.on("@setmaxspatiallayer", (spatialLayer, callback, errback) => {
            this._awaitQueue
                .push(async () => this._handler.setMaxSpatialLayer(producer.localId, spatialLayer))
                .then(callback)
                .catch(errback);
        });
        producer.on("@setrtpencodingparameters", (params, callback, errback) => {
            this._awaitQueue
                .push(async () => this._handler.setRtpEncodingParameters(producer.localId, params))
                .then(callback)
                .catch(errback);
        });
        producer.on("@getstats", (callback, errback) => {
            if (this._closed)
                return errback(new Error("closed"));
            this._handler
